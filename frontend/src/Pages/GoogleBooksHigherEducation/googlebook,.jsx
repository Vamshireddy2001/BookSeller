...
function GoogleBooksHigherEducation()
{
  ...
  const fetchCoding=async ()=>{
    const response=await fetchBooks("Higher Education")
    if(response)
    {
  ...
  <div className='GoogleSellerContainer'>
    ...
    <h3 style={{marginLeft:"30px"}}>Higher Education</h3>
...
export default GoogleBooksHigherEducation;